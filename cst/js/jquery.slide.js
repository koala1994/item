...
;(function(global,$){
        $.fn.slide = function(opt){
            ...
            slide.fn = slide.prototype = {
                ...
                innerWrap:"<div class=\"inner_wrap\"><a href=\"@{url}\"><img src=\"@{img}\" alt=\"@{alt}\"></a><div class=\"img_ttl\">@{alt}</div></div>",//图片内部容器
                ...
                _listImgs:function(index){//图片滑动函数
                    this.imgWrap.animate({'left':-(index-1)*this.wrapWidth+'px'},opt.duration);
                    return this;
                },
                ...
                init:function(){//初始化函数
                    ...
                    if(!opt.arrow_ctrl){
                        this.btnLeft.css('left','-9999px');
                        this.btnRight.css('left','-9999px');
                        this.control.css('left','-9999px');
                    }
                }
